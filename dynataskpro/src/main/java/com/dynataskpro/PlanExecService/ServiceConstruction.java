...
public class ServiceConstruction extends Service {
    ...
    // Constructeur de ServiceConstruction
    ...
    public void evaluerQualification() {
        // Logique d'évaluation de la qualification pour le service de construction
        System.out.println("Évaluation de la qualification pour le service : " + getServiceName());
        // Ajoutez ici toute la logique spécifique à l'évaluation de la qualification pour le service de construction
    }

    @Override
    public void effectuerVerification() {
        // Logique d'effectuation de la vérification pour le service de construction
        System.out.println("Effectuation de la vérification pour le service : " + getServiceName());
        // Ajoutez ici toute la logique spécifique à l'effectuation de la vérification pour le service de construction
    }
    ...
    public void verifieProjet(Demand demande) {
        ...
        // Supposons que pour le service de construction, nous devons vérifier que la demande
        // contient une description détaillée des travaux à effectuer
        
        if (demande.getDescriptionProjet() != null && !demande.getDescriptionProjet().isEmpty()) {
            System.out.println("Le projet a été vérifié avec succès pour le service de construction");
        } else {
            System.out.println("La vérification du projet pour le service de construction a échoué : description des travaux manquante");
        }
    }

    @Override
    public String getServiceName() {
        return "Service de Construction";
    }
}
